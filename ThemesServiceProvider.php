...
class ThemesServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands('Magnusdeus\Themes\Console\MakeCommand');
        $this->commands('Magnusdeus\Themes\Console\CacheCommand');
        $this->commands('Magnusdeus\Themes\Console\ListCommand');
        $this->commands('Magnusdeus\Themes\Console\PublishCommand');
    }
